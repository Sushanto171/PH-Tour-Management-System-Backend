...
exports.multerUpload = exports.deleteImageFromCloudinary = void 0;
...
const deleteImageFromCloudinary = (imageUrl) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (match && match[1]) {
            ...
            yield cloudinary_config_1.cloudinaryUpload.uploader.destroy(publicId);
            console.log(`File ${publicId} is deleted from cloudinary.`);
        }
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
    }
    catch (error) {
        throw new AppError_1.AppError(401, "Cloudinary Image deletion error", error);
    }
});
